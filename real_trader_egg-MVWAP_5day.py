...
def get_mvwap(symbols:list):
    ...
    for sym in symbols: ### iterate through symbols and gather mwvap
        ...
        try:
            ...
            for bar in range(0, 5): ### exclude today in iteration, and only get 5 day mvwap
                try:
